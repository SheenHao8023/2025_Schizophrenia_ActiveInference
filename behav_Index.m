clc; clear;
basepath = "C:\Users\XinHao\Desktop\2025_SCZ_AI\empirical_data\behav_rawfiles\";
...
for i = 1:numel(subfolders)
    ...
    pair.WS(abs(pair.WS - median(pair.WS, 'omitnan')) > 3 * median(abs(pair.WS - median(pair.WS, 'omitnan')), 'omitnan')) = NaN;
    pair.IC(abs(pair.WS - median(pair.IC, 'omitnan')) > 3 * median(abs(pair.IC - median(pair.IC, 'omitnan')), 'omitnan')) = NaN;
