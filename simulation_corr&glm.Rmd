...
## R Markdown
这个R markdown用来储存simulation data的相关性分析和GLM分析代码和结果，并包含初步图片生成，以帮助研究者复现文中的实验结果。
...
## GLM分析
```{r glmanalysis, message=FALSE, warning=FALSE}
...
## 成对比较分析
```{r contrastanalysis, message=FALSE, warning=FALSE}
